...
$add_auction = mysqli_query($conn, $qry) or die("query not fire");
...
$data = mysqli_query($conn, $query) or die("query not fire");

$query = "select * from add_player where row_id='$pid'";
$data1 = mysqli_query($conn, $query) or die("query not fire");

$query = "select * from add_player where row_id='$pid'";
$data2 = mysqli_query($conn, $query) or die("query not fire");
...
<body>
    ...
    <main>
                ...
                <div class="container marketing">
                    <div class="row mt-3">
                        <div class="col-lg-4">
                            ...
                            ?>
                                <div class="card" style="width: 230px;height:420px">
                                    ...
                                    <div class="card-body text-start">
                                        ...
                                        <h5 class="card-title">Value : <?php echo $fasih['amt'] ?></56>
                                            <h5 class="card-title">Team Player : <?php echo $fasih['t_player'] ?></h5>
                                            <!-- <h1> $_SESSION['user']
                                        Time: <?php echo $fasih['_time'] ?>
                                        </h1> -->
                                    </div>
                                </div>
                            <?php } ?>
                        ...
                        <?php if (!empty($_SESSION['user'])) {  ?>
                                ...
                                <div class="col-lg-8" id="bidvalue">
                                    <form action="action.php" method="post" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Value</label>
                                            <input type="text" name="value" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Player Amount To Buy">
                                            <div class="form-text">
        ...
        <div id="startButtons">
            <button id="gameStart" type="submit" value="<?php print($_time) ?>" class="btn btn-primary">GO</button>
        </div>
