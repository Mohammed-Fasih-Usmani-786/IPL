...
$query = "select * from bid where ow_id='$ow_id'";
...
foreach ($p as $v) {
    ...
    $d2 = [];
    foreach ($d as $v1) {
        if ($v['row_id'] == $v1['p_id'] && $v1['ow_id'] == $ow_id) {
            $row_id = $v['row_id'];
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <img src="<?php echo $fasih[0]['p_img'] ?>" height="50px" width="50px">
                        </td>
