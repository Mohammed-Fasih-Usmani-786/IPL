...
$qry = "select * from add_player where t_code='$t_code'";
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <img src="admin/<?php echo $fasih['p_img'] ?>" height="50px" width="50px">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <div class="card" style="width: 18rem;">
                        <img src="<?php echo $fasih['p_img'] ?>" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo $fasih['name'] ?></h5>
                            <p class="card-text">Price:<?php echo $fasih['amt'] ?></p>
                            <p class="card-text">Team Player:<?php echo $fasih['t_player'] ?></p>
